const LocalGuestCuratorCardApi =  [
    {
        ...
        linkTitle:"See List",
        subTitle:"Tal Minear",
        content:"Tal Minear is a voice actor, sound designer, and audio drama producer. They're the creator of Re: Dracula, Sidequesting, and several other productions that can be found hiding under rugs and around corners.",
